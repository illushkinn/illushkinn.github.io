...
const i18n = {
  en: {
    ...
    'card-3-title': 'AI \u00B7 Education',
    'card-3-desc': 'Smart automation for your processes. Accessible EdTech for your schools. AI that augments, never replaces.',
    'section-approach-label': 'How We Build',
    'section-approach-title': '<span class="text-accent">Spec-first</span>, UX-centered.',
    'card-a1-title': 'Spec-First, UX-Centered',
    'card-a1-desc': 'Digital accessibility is strategy. We define goals, design, test, and only then build. Predictable process, predictable results.',
    'card-a2-title': 'The Right Tools for Your Project',
    'card-a2-desc': 'We choose what solves your real problem \u2014 without inflating costs or complexity.',
    'card-a3-title': 'Your Message Reaches Further',
    'card-a3-desc': 'Your message, adapted for every audience. We craft content that connects naturally in each language and culture. More reach, without losing your voice.',
  ...
  es: {
    ...
    'card-3-title': 'IA \u00B7 Educación',
    'card-3-desc': 'Automatización inteligente para tus procesos. EdTech accesible para tus escuelas. IA que potencia, nunca reemplaza.',
    'section-approach-label': 'Cómo Construimos',
    'section-approach-title': '<span class="text-accent">Spec-first</span>, centrado en UX.',
    'card-a1-title': 'Spec-First, UX-Centrado',
    'card-a1-desc': 'La accesibilidad digital es estrategia. Definimos objetivos, diseñamos, probamos, y recién construimos. Proceso predecible, resultados predecibles.',
    'card-a2-title': 'Las herramientas justas para tu proyecto',
    'card-a2-desc': 'Elegimos lo que resuelve tu problema real, sin inflar costos ni complejidad.',
    'card-a3-title': 'Tu mensaje llega más lejos',
    'card-a3-desc': 'Tu mensaje, adaptado para cada audiencia. Creamos contenido que conecta naturalmente en cada idioma y cultura. Más alcance, sin perder tu voz.',
  ...
  ua: {
    ...
    'card-3-title': 'ШІ \u00B7 Освіта',
    'card-3-desc': 'Розумна автоматизація для ваших процесів. Доступна EdTech для ваших шкіл. ШІ, який посилює, ніколи не замінює.',
    'section-approach-label': 'Як ми будуємо',
    'section-approach-title': '<span class="text-accent">Spec-first</span>, орієнтовано на UX.',
    'card-a1-title': 'Spec-First, UX-Орієнтовано',
    'card-a1-desc': 'Цифрова доступність — це стратегія. Визначаємо цілі, проектуємо, тестуємо, і тільки тоді будуємо. Передбачуваний процес, передбачувані результати.',
    'card-a2-title': 'Правильні інструменти для вашого проекту',
    'card-a2-desc': 'Обираємо те, що вирішує вашу реальну проблему — без завищення витрат чи складності.',
    'card-a3-title': 'Ваше повідомлення сягає далі',
    'card-a3-desc': 'Ваше повідомлення, адаптоване для кожної аудиторії. Ми створюємо контент, який природньо резонує в кожній мові та культурі. Більше охоплення, без втрати вашого голосу.',
  ...
  ru: {
    ...
    'card-3-title': 'ИИ \u00B7 Образование',
    'card-3-desc': 'Умная автоматизация для ваших процессов. Доступная EdTech для ваших школ. ИИ, который усиливает, никогда не заменяет.',
    'section-approach-label': 'Как мы строим',
    'section-approach-title': '<span class="text-accent">Spec-first</span>, ориентировано на UX.',
    'card-a1-title': 'Spec-First, UX-Ориентировано',
    'card-a1-desc': 'Цифровая доступность — это стратегия. Определяем цели, проектируем, тестируем, и только потом строим. Предсказуемый процесс, предсказуемые результаты.',
    'card-a2-title': 'Правильные инструменты для вашего проекта',
    'card-a2-desc': 'Выбираем то, что решает вашу реальную проблему — без завышения затрат и сложности.',
    'card-a3-title': 'Ваше сообщение достигает большего',
    'card-a3-desc': 'Ваше сообщение, адаптированное для каждой аудитории. Мы создаем контент, который естественно резонирует на каждом языке и в каждой культуре. Больше охвата, без потери вашего голоса.',
