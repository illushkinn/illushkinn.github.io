...
const i18n = {
  en: {
    ...
    'card-a3-title': 'Every User. Every Language.',
    'card-a3-desc': 'Your platform. Every user you reach. Every language you speak.',
  ...
  es: {
    ...
    'card-a3-title': 'Cada Usuario. Cada Idioma.',
    'card-a3-desc': 'Tu plataforma. Cada usuario que alcanzás. Cada idioma que hablás.',
  ...
  ua: {
    ...
    'card-a3-title': 'Кожен Користувач. Кожна Мова.',
    'card-a3-desc': 'Ваша платформа. Кожен користувач, якого ви охоплюєте. Кожна мова, якою ви говорите.',
  ...
  ru: {
    ...
    'card-a3-title': 'Каждый Пользователь. Каждый Язык.',
    'card-a3-desc': 'Ваша платформа. Каждый пользователь, которого вы охватываете. Каждый язык, на котором вы говорите.',
